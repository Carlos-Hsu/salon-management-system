...
export type Database = {
  public: {
    Tables: {
      ...
      services: { Row: { id: number; name: string; duration_min: number; price: number; active: boolean; deleted_at: string | null; created_at: string; updated_at: string }; Insert: { name: string; duration_min: number; price: number; active?: boolean; deleted_at?: string | null }; Update: { name?: string; duration_min?: number; price?: number; active?: boolean; deleted_at?: string | null }; Relationships: [] };
    ...
    Functions: {
      ...
      create_appointment: { Args: { p_customer_id: number; p_service_id: number | null; p_start_time: string; p_status?: string; p_custom_items?: unknown[]; p_note?: string; p_custom_service_name?: string | null; p_custom_service_duration?: number | null; p_custom_service_price?: number | null }; Returns: Database['public']['Tables']['appointments']['Row'] };
      update_appointment: { Args: { p_id: number; p_customer_id: number; p_service_id: number | null; p_start_time: string; p_status: string; p_custom_items?: unknown[]; p_note?: string; p_custom_service_name?: string | null; p_custom_service_duration?: number | null; p_custom_service_price?: number | null }; Returns: Database['public']['Tables']['appointments']['Row'] };
      ...
      permanently_delete_customer: { Args: { p_customer_id: number }; Returns: number };

...
const apiImpl = {
  ...
  deleteCustomer: async (id:number) => { if (!isSupabaseConfigured) return expressApi.deleteCustomer(id); row(await sb().rpc('permanently_delete_customer',{p_customer_id:id})); },
